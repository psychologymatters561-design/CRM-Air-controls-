...
{"email": "Subject: ...\n\n[body here]", "wa": "[whatsapp message here]"}`;
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0d0d14",fontFamily:"'Georgia',serif",color:"#e2e8f0",display:"flex",flexDirection:"column"}}>
      ...
      {/* SETTINGS DRAWER */}
      {showSettings && (
        <div style={{background:"#0f172a",borderBottom:"1px solid #1e293b",padding:"16px 20px",display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
          <span style={{fontSize:11,color:"#64748b",fontFamily:"monospace"}}>Anthropic API Key:</span>
          ...
          <span style={{fontSize:10,color:"#334155",fontFamily:"monospace"}}>Required for AI message generation. Get yours at console.anthropic.com</span>
        </div>
      )}
